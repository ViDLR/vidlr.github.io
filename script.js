const translations = {
    en: {
        ...
        aboutTitle: "About Me",
        aboutContent: "Hello! My name is Virgile de La Rochefoucauld, and I am passionate about robotics and trans-media multi-robot systems. I am currently pursuing a double degree PhD program between Japan and France, where I have the opportunity to work on cutting-edge research in robotics and artificial intelligence.",
    ...
    jp: {
        ...
        menuDownload: "ダウンロード",
        aboutTitle: "私について",
        aboutContent: "こんにちは！私の名前はヴィルジル・ド・ラ・ロシュフコーです。ロボット工学とトランスメディア・マルチロボットシステムに情熱を注いでいます。現在、日本とフランスでダブルディグリーの博士課程に在籍し、ロボット工学と人工知能の最先端の研究に取り組んでいます。",
